// app/hotwheels/page.tsx - VERSÃO OTIMIZADA (FILTRO ESGOTADOS + CÓDIGO LIMPO)
'use client';
    ...
    <div style={{ minHeight: '100vh', background: colors.background, color: colors.text }}>
      ...
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: '0px 20px' }}>
        <h1 style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>
          Hot Wheels em Manaus — Videra Store
        </h1>
        {!ready && (
          <div className="global-loading-container" style={{ padding: '80px 20px' }}>
            ...
            <p className="global-loading-text" style={{ fontSize: '18px', color: colors.text }}>Carregando Hot Wheels...</p>
          </div>
        )}
                  ...
                  <div>
                    <Carousel
                      ...
                      config={carouselConfigs.find(c => c.carousel_type === 'all') || {
                        page_slug: 'hotwheels', carousel_type: 'all',
                        ...
                        id: 'temp-hotwheels-all', created_at: new Date().toISOString(), updated_at: new Date().toISOString()
                      }}
                    ...
                    <Carousel
                      ...
                      config={carouselConfigs.find(c => c.carousel_type === 'bestsellers') || {
                        page_slug: 'hotwheels', carousel_type: 'bestsellers',
                        title_text_color: colors.text, title_font_size: 24, title_font_weight: '700',
                    ...
                    <Carousel
                      ...
                      config={carouselConfigs.find(c => c.carousel_type === 'new_arrivals') || {
                        page_slug: 'hotwheels', carousel_type: 'new_arrivals',
                        title_text_color: colors.text, title_font_size: 24, title_font_weight: '700',
